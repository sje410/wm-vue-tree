...
<script>
import Vue from "vue";
import WmTreeNode from "./WmTreeNode.vue";
...
.horizontal .org-chart-node-label .org-chart-node-label-inner-disabled:hover {
  cursor: not-allowed;
}

.horizontal .org-chart-node-label .org-chart-node-label-inner-text-disabled:hover {
  cursor: not-allowed;
}

.horizontal .tree-node-name {
  /*display: block;*/
  max-width: 200px;
  overflow: hidden;
...
.horizontal .tree-node-name-status {
  margin-right: 5px;
}

.horizontal .org-chart-node-label .org-chart-node-label-inner-text {
  display: inline-block;
  padding: 5px 5px;
...
.horizontal .org-chart-node-label .org-chart-node-label-inner-text:hover {
  cursor: pointer;
}
